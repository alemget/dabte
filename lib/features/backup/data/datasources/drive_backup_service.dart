...
import '../../domain/entities/drive_backup_info.dart' as domain_drive_info;
import '../../domain/entities/drive_backup_result.dart' as domain_drive_result;
...
/// نتيجة عملية الرفع
typedef DriveBackupResult = domain_drive_result.DriveBackupResult;

/// معلومات نسخة احتياطية في Drive
typedef DriveBackupInfo = domain_drive_info.DriveBackupInfo;
