...
import '../../domain/entities/backup_format.dart';
import '../../domain/entities/backup_metadata.dart';
import '../../domain/entities/backup_result.dart' as domain_backup_result;
import '../../domain/entities/restore_result.dart' as domain_restore_result;
import '../managers/backup_file_manager.dart';
...
class LocalBackupService {
  ...
  Future<domain_backup_result.BackupResult> createBackup([String? customPath]) async {
    try {
      ...
      if (!await dbFile.exists()) {
        return domain_backup_result.BackupResult(
          success: false,
  ...
  Future<domain_backup_result.BackupResult> createTempBackup() async {
    try {
  ...
  Future<domain_backup_result.BackupResult> createAutoBackup() async {
    try {
  ...
  Future<domain_backup_result.BackupResult> createBackupWithName(String destinationPath, String fileName) async {
    try {
      debugPrint('بدء إنشاء النسخة الاحتياطية...');
  ...
  Future<domain_restore_result.RestoreResult> restoreBackup(String backupFilePath) async {
    try {
      ...
      if (!await backupFile.exists()) {
        return domain_restore_result.RestoreResult(
          success: false,
...
typedef BackupResult = domain_backup_result.BackupResult;

/// نتيجة الاستعادة
typedef RestoreResult = domain_restore_result.RestoreResult;
