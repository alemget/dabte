...
class _AddEditClientPageState extends State<AddEditClientPage> {
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      if (_isEditMode) {
        await DebtDatabase.instance.updateClient(widget.client!.id!, name, phone: phone);
      } else {
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon: Icon(Icons.badge_outlined, color: isDark ? Colors.grey[400] : Colors.grey[500]),
                                ),
                                validator: (v) => v!.trim().isEmpty ? l10n.clientNameRequired : null,
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon: Icon(Icons.phone_outlined, color: isDark ? Colors.grey[400] : Colors.grey[500]),
                                ),
